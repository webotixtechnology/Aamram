...
function validateStep(stepIndex) {
  var currentForm = fieldsets[stepIndex];
  var inputs = currentForm.querySelectorAll('input[required], select[required], textarea[required]');
  var valid = true;

  // Iterate through all required inputs and check if they are valid
